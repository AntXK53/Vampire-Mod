...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.85f; //0.7f;
...
static const float GB_THRESHOLD = 0.10f; // interpolation time
static const float GB_THRESHOLD2 = 0.75f; // interpolation time
